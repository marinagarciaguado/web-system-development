...
// Assume you will create a specific component for the visual map later
import IngredientVisualMap from '../components/IngredientVisualMap'; 

const Home = () => {
  return (
    <div className="home-container">
      {/* -------------------- Top Section: Freshness & Products -------------------- */}
      <section className="home-section freshness-banner">
      ...
      {/* -------------------- Mid Section: Brand History & Values -------------------- */}
      ...
      {/* -------------------- Product Range / Visual Map Placeholder (Moved Down) -------------------- */}
      <section className="home-section ingredients-section">
        ...
        {/* Placeholder for the detailed visual ingredient map */}
        <IngredientVisualMap /> 
