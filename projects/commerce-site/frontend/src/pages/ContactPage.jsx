...
const ContactPage = () => {
  ...
  return (
    <div className="contact-container">
      <h1>Contáctanos</h1>
      <p className="contact-subtitle">Estamos aquí para ayudarte. Envíanos un mensaje o visítanos.</p>
      
      <div className="contact-grid">
        {/* --- COLUMNA IZQUIERDA: Formulario --- */}
        {/* Usamos la etiqueta 'form' para heredar los estilos de App.css */}
...
=======
export default ContactPage;
>>>>>>> bc2db49e58f517cbbcd216960f6dc5f8cf0d47a4
